...
class Funciones
{
    ...
    public static function ArmarCorreo($cliente = "David Coello", $direcion = "Guasmo", $phone = "0987654321", $tabla = "", $footerInt = '', $retiro = "")
    {
        $armarTablaFactura = '
        <table align="center" border="0" cellpadding="0" cellspacing="0$retiro" height="100%" width="100%">
            <tbody>
                <tr>
                            ...
                            <tbody>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td valign="top" align="center">
                                                        <a href="farmaciasmegasalud.com"><img alt="" src="cid:logo_2u" width="272" style="padding-bottom: 0; display: inline !important" /></a>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td width="100%" height="40">&nbsp;</td>
                                ...
                                <tr>
                                    <td class="tablepadding" style="padding: 20px; font-size: 14px; line-height: 20px">
                                        Aquí tienes un resumen de tu compra. Cuando enviemos el artículo, enviaremos una actualización con detalles.
                                    </td>
                                </tr>
                                <tr>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td style="font-size: 13px; font-family: Arial, Helvetica, sans-serif; color: #676767" align="right">
                                                        <span style="color: #707070">Fecha pedido: </span><span style="color: #000000; display: inline-block">' . (date("d-m-Y")) . '</span>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    ...
                                                                                    <td style="font-size: 13.5px; font-family: Arial, Helvetica, sans-serif; line-height: 1.5; color: #000000">
                                                                                        <span style="color: #909090">Dirección de entrega</span><br />
                                                                                        ' . $cliente . '<br />
                                                                                        ' . $direcion . '
                                                                                    </td>
                                                                                </tr>
                                                                    ...
                                                                    <td class="tablepadding" style="padding: 20px">
                                                                        <table width="100%" align="left" cellpadding="0" cellspacing="0" border="0">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td valign="top" width="40" style="padding: 3px 0 0 0">
                                                                                        <img src="phone-icon.png" width="22" height="20" alt="" />
                                                                                    </td>
                                                                                    <td style="font-size: 13.5px; font-family: Arial, Helvetica, sans-serif; line-height: 1.5; color: #000000">
                                                                                        <span style="color: #909090">Número de telefono</span><br />
                                                                                        ' . $phone . '
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
